...
def to_binary(input_number: int) -> int:
    ...
    :param input_number: The decimal number that you want to convert to binary
...
def validate_input(input_number:int)->None:
    ...
    :param input_number: The input_number parameter is an integer to be validated
    :type input_number: int
    """
    if input_number < 0:
...
def highest_power_of_two(input_number:int)->int:
    ...
    :param input_number: Integer that represents for which we want to find the highest power of two
    :type input_number: int
