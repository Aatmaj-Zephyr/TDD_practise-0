...
my_fruit_shopping_list = ShoppingList("Fruits", "Aatmaj")


def test_for_inititialization_of_shopping_list():
    """
...
def test_adding_an_item_and_checking_length_of_shopping_list():
    """
...
def test_adding_repeative_items_raises_error():
    """
